	...
	public sealed partial class Poi : global::Java.Lang.Object, global::Android.OS.IParcelable {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (Poi)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/lang/String;Ljava/lang/String;D)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/lang/String;Ljava/lang/String;D)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_lang_String_Ljava_lang_String_D, __args);
			} finally {
		...
		public unsafe double Rank {
			...
			get {
				...
				try {
					return JNIEnv.CallDoubleMethod  (Handle, id_getRank);
				} finally {
				}
			}
		}
