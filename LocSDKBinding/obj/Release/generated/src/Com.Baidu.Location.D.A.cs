...
namespace Com.Baidu.Location.D {
	...
	public partial class A : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.baidu.location.d']/class[@name='a']/field[@name='fE']"
		[Register ("fE")]
		public const string FE = (string) "android.com.baidu.location.TIMER.NOTIFY";
