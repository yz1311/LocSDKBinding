...
namespace Com.Baidu.Location {
	...
	public sealed partial class Address : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.baidu.location']/class[@name='Address']/field[@name='address']"
		[Register ("address")]
		...
		public string CityCode {
			get {
				...
				IntPtr __ret = JNIEnv.GetObjectField (Handle, cityCode_jfieldId);
				return JNIEnv.GetString (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (cityCode_jfieldId == IntPtr.Zero)
				...
				IntPtr native_value = JNIEnv.NewString (value);
				try {
					JNIEnv.SetField (Handle, cityCode_jfieldId, native_value);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
		...
		public string CountryCode {
			get {
				...
				IntPtr __ret = JNIEnv.GetObjectField (Handle, countryCode_jfieldId);
				return JNIEnv.GetString (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (countryCode_jfieldId == IntPtr.Zero)
				...
				IntPtr native_value = JNIEnv.NewString (value);
				try {
					JNIEnv.SetField (Handle, countryCode_jfieldId, native_value);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
			...
			public virtual unsafe global::Com.Baidu.Location.Address Build ()
			{
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address> (JNIEnv.CallObjectMethod  (Handle, id_build), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "build", "()Lcom/baidu/location/Address;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Baidu.Location.Address.Builder City (string p0)
			{
				...
				try {
					...
					if (GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallObjectMethod  (Handle, id_city_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "city", "(Ljava/lang/String;)Lcom/baidu/location/Address$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Baidu.Location.Address.Builder CityCode (string p0)
			{
				...
				try {
					...
					global::Com.Baidu.Location.Address.Builder __ret;
					if (GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallObjectMethod  (Handle, id_cityCode_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "cityCode", "(Ljava/lang/String;)Lcom/baidu/location/Address$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Baidu.Location.Address.Builder Country (string p0)
			{
				...
				try {
					...
					global::Com.Baidu.Location.Address.Builder __ret;
					if (GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallObjectMethod  (Handle, id_country_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "country", "(Ljava/lang/String;)Lcom/baidu/location/Address$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Baidu.Location.Address.Builder CountryCode (string p0)
			{
				...
				try {
					...
					global::Com.Baidu.Location.Address.Builder __ret;
					if (GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallObjectMethod  (Handle, id_countryCode_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "countryCode", "(Ljava/lang/String;)Lcom/baidu/location/Address$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Baidu.Location.Address.Builder District (string p0)
			{
				...
				try {
					...
					global::Com.Baidu.Location.Address.Builder __ret;
					if (GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallObjectMethod  (Handle, id_district_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "district", "(Ljava/lang/String;)Lcom/baidu/location/Address$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Baidu.Location.Address.Builder Province (string p0)
			{
				...
				try {
					...
					global::Com.Baidu.Location.Address.Builder __ret;
					if (GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallObjectMethod  (Handle, id_province_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "province", "(Ljava/lang/String;)Lcom/baidu/location/Address$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Baidu.Location.Address.Builder Street (string p0)
			{
				...
				try {
					...
					global::Com.Baidu.Location.Address.Builder __ret;
					if (GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallObjectMethod  (Handle, id_street_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "street", "(Ljava/lang/String;)Lcom/baidu/location/Address$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
...
#pragma warning restore 0169
			...
			public virtual unsafe global::Com.Baidu.Location.Address.Builder StreetNumber (string p0)
			{
				...
				try {
					...
					global::Com.Baidu.Location.Address.Builder __ret;
					if (GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallObjectMethod  (Handle, id_streetNumber_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.Address.Builder> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "streetNumber", "(Ljava/lang/String;)Lcom/baidu/location/Address$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
