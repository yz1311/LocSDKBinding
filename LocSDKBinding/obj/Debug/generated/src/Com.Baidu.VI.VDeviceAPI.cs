...
namespace Com.Baidu.VI {
	...
	public partial class VDeviceAPI : global::Java.Lang.Object {
		...
		static IntPtr id_getNetworkInfo_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.vi']/class[@name='VDeviceAPI']/method[@name='getNetworkInfo' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("getNetworkInfo", "(I)Lcom/baidu/vi/c;", "")]
		public static unsafe global::Com.Baidu.VI.c_ GetNetworkInfo (int p0)
		{
			if (id_getNetworkInfo_I == IntPtr.Zero)
				id_getNetworkInfo_I = JNIEnv.GetStaticMethodID (class_ref, "getNetworkInfo", "(I)Lcom/baidu/vi/c;");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.VI.c_> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getNetworkInfo_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
