	...
	public abstract partial class BDNotifyListener : global::Java.Lang.Object {
		...
		public int Notified {
			get {
				...
				return JNIEnv.GetIntField (Handle, Notified_jfieldId);
			}
			set {
				if (Notified_jfieldId == IntPtr.Zero)
					Notified_jfieldId = JNIEnv.GetFieldID (class_ref, "Notified", "I");
				try {
					JNIEnv.SetField (Handle, Notified_jfieldId, value);
				} finally {
				}
			}
		}
		...
		public float DifferDistance {
			get {
				...
				return JNIEnv.GetFloatField (Handle, differDistance_jfieldId);
			}
			set {
				if (differDistance_jfieldId == IntPtr.Zero)
					differDistance_jfieldId = JNIEnv.GetFieldID (class_ref, "differDistance", "F");
				try {
					JNIEnv.SetField (Handle, differDistance_jfieldId, value);
				} finally {
				}
			}
		}
		...
		public bool IsAdded {
			get {
				...
				return JNIEnv.GetBooleanField (Handle, isAdded_jfieldId);
			}
			set {
				if (isAdded_jfieldId == IntPtr.Zero)
					isAdded_jfieldId = JNIEnv.GetFieldID (class_ref, "isAdded", "Z");
				try {
					JNIEnv.SetField (Handle, isAdded_jfieldId, value);
				} finally {
				}
			}
		}
		...
		public string MCoorType {
			get {
				...
				IntPtr __ret = JNIEnv.GetObjectField (Handle, mCoorType_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetField (Handle, mCoorType_jfieldId, native_value);
				} finally {
		...
		public double MLatitude {
			get {
				...
				return JNIEnv.GetDoubleField (Handle, mLatitude_jfieldId);
			}
			set {
				if (mLatitude_jfieldId == IntPtr.Zero)
					mLatitude_jfieldId = JNIEnv.GetFieldID (class_ref, "mLatitude", "D");
				try {
					JNIEnv.SetField (Handle, mLatitude_jfieldId, value);
				} finally {
				}
			}
		}
		...
		public double MLatitudeC {
			get {
				...
				return JNIEnv.GetDoubleField (Handle, mLatitudeC_jfieldId);
			}
			set {
				if (mLatitudeC_jfieldId == IntPtr.Zero)
					mLatitudeC_jfieldId = JNIEnv.GetFieldID (class_ref, "mLatitudeC", "D");
				try {
					JNIEnv.SetField (Handle, mLatitudeC_jfieldId, value);
				} finally {
				}
			}
		}
		...
		public double MLongitude {
			get {
				...
				return JNIEnv.GetDoubleField (Handle, mLongitude_jfieldId);
			}
			set {
				if (mLongitude_jfieldId == IntPtr.Zero)
					mLongitude_jfieldId = JNIEnv.GetFieldID (class_ref, "mLongitude", "D");
				try {
					JNIEnv.SetField (Handle, mLongitude_jfieldId, value);
				} finally {
				}
			}
		}
		...
		public double MLongitudeC {
			get {
				...
				return JNIEnv.GetDoubleField (Handle, mLongitudeC_jfieldId);
			}
			set {
				if (mLongitudeC_jfieldId == IntPtr.Zero)
					mLongitudeC_jfieldId = JNIEnv.GetFieldID (class_ref, "mLongitudeC", "D");
				try {
					JNIEnv.SetField (Handle, mLongitudeC_jfieldId, value);
				} finally {
				}
			}
		}

		static IntPtr mNotifyCache_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.baidu.location']/class[@name='BDNotifyListener']/field[@name='mNotifyCache']"
		[Register ("mNotifyCache")]
		public global::Com.Baidu.Location.D.A MNotifyCache {
			get {
				if (mNotifyCache_jfieldId == IntPtr.Zero)
					mNotifyCache_jfieldId = JNIEnv.GetFieldID (class_ref, "mNotifyCache", "Lcom/baidu/location/d/a;");
				IntPtr __ret = JNIEnv.GetObjectField (Handle, mNotifyCache_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Location.D.A> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (mNotifyCache_jfieldId == IntPtr.Zero)
					mNotifyCache_jfieldId = JNIEnv.GetFieldID (class_ref, "mNotifyCache", "Lcom/baidu/location/d/a;");
				...
				try {
					JNIEnv.SetField (Handle, mNotifyCache_jfieldId, native_value);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
		...
		public float MRadius {
			get {
				...
				return JNIEnv.GetFloatField (Handle, mRadius_jfieldId);
			}
			set {
				if (mRadius_jfieldId == IntPtr.Zero)
					mRadius_jfieldId = JNIEnv.GetFieldID (class_ref, "mRadius", "F");
				try {
					JNIEnv.SetField (Handle, mRadius_jfieldId, value);
				} finally {
				}
			}
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (BDNotifyListener)) {
					SetHandle (
		...
		public virtual unsafe void SetNotifyLocation (double p0, double p1, float p2, string p3)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_SetNotifyLocation_DDFLjava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "SetNotifyLocation", "(DDFLjava/lang/String;)V"), __args);
			} finally {
...
#pragma warning restore 0169
		...
		public virtual unsafe void OnNotify (global::Com.Baidu.Location.BDLocation p0, float p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_onNotify_Lcom_baidu_location_BDLocation_F, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onNotify", "(Lcom/baidu/location/BDLocation;F)V"), __args);
			} finally {
			}
		}
