...
namespace Com.Baidu.Location {
	...
	public partial class Jni : global::Java.Lang.Object {
		...
		static IntPtr id_dI;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.location']/class[@name='Jni']/method[@name='dI' and count(parameter)=0]"
		[Register ("dI", "()Ljava/lang/String;", "")]
		public static unsafe string DI ()
		{
			if (id_dI == IntPtr.Zero)
				id_dI = JNIEnv.GetStaticMethodID (class_ref, "dI", "()Ljava/lang/String;");
			try {
				return JNIEnv.GetString (JNIEnv.CallStaticObjectMethod  (class_ref, id_dI), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
