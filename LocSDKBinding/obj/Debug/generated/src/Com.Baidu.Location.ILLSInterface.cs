...
namespace Com.Baidu.Location {
	...
	public partial interface ILLSInterface : IJavaObject {
		...
		double Version {
			...
			[Register ("getVersion", "()D", "GetGetVersionHandler:Com.Baidu.Location.ILLSInterfaceInvoker, LocSDKBinding")] get;
		}
		...
		[Register ("onBind", "(Landroid/content/Intent;)Landroid/os/IBinder;", "GetOnBind_Landroid_content_Intent_Handler:Com.Baidu.Location.ILLSInterfaceInvoker, LocSDKBinding")]
		...
		[Register ("onCreate", "(Landroid/content/Context;)V", "GetOnCreate_Landroid_content_Context_Handler:Com.Baidu.Location.ILLSInterfaceInvoker, LocSDKBinding")]
		...
		[Register ("onDestroy", "()V", "GetOnDestroyHandler:Com.Baidu.Location.ILLSInterfaceInvoker, LocSDKBinding")]
		void OnDestroy ();
		...
		[Register ("onStartCommand", "(Landroid/content/Intent;II)I", "GetOnStartCommand_Landroid_content_Intent_IIHandler:Com.Baidu.Location.ILLSInterfaceInvoker, LocSDKBinding")]
		...
		[Register ("onUnBind", "(Landroid/content/Intent;)Z", "GetOnUnBind_Landroid_content_Intent_Handler:Com.Baidu.Location.ILLSInterfaceInvoker, LocSDKBinding")]
...
#pragma warning restore 0169
		...
		public unsafe double Version {
			get {
				...
				return JNIEnv.CallDoubleMethod (Handle, id_getVersion);
			}
		}
...
#pragma warning restore 0169
		...
		public unsafe global::Android.OS.IBinder OnBind (global::Android.Content.Intent p0)
		{
			...
			global::Android.OS.IBinder __ret = global::Java.Lang.Object.GetObject<global::Android.OS.IBinder> (JNIEnv.CallObjectMethod (Handle, id_onBind_Landroid_content_Intent_, __args), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
...
#pragma warning restore 0169
		...
		public unsafe void OnCreate (global::Android.Content.Context p0)
		{
			...
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue (p0);
			JNIEnv.CallVoidMethod (Handle, id_onCreate_Landroid_content_Context_, __args);
		}
...
#pragma warning restore 0169
		...
		public unsafe int OnStartCommand (global::Android.Content.Intent p0, int p1, int p2)
		{
			...
			int __ret = JNIEnv.CallIntMethod (Handle, id_onStartCommand_Landroid_content_Intent_II, __args);
			return __ret;
		}
...
#pragma warning restore 0169
		...
		public unsafe bool OnUnBind (global::Android.Content.Intent p0)
		{
			...
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue (p0);
			bool __ret = JNIEnv.CallBooleanMethod (Handle, id_onUnBind_Landroid_content_Intent_, __args);
			return __ret;
		}
